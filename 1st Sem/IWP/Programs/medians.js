...
//   Return value: none
//To find Median we have to rewrite your list first in sequncial order.
...
// Test driver
var my_list_0 = [3, 8, 9, 1, 5, 7, 9, 21];
var my_list_1 = [8, 3, 9, 1, 4, 7];
var my_list_2 = [10, -2, 0, 5, 3, 1, 7];
var med = median(my_list_0); 
document.write("Median of [", my_list_0, "] is: ", med, "<br />")
