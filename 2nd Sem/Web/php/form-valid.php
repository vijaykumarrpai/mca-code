...
function test_input($data) {
  ...
  //PHP addslashes() and stripslashes() Functions. addslashes(string) — This PHP function returns a string with backslashes in front of each character that needs to be quoted in a database query.
...
<?php
print htmlspecialchars('<br><h1>Input example</h1>');
